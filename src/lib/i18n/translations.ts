...
const en: TranslationStrings = {
    ...
    dashboard_daily_revenue_margin: 'Monthly revenue and margin for the current year',
    dashboard_wastage_title: 'Wastage',
    ...
    dashboard_top_selling: 'Top Selling Items',
    dashboard_worst_selling: 'Worst Selling Items',
    ...
    category_signature_dishes: 'Top Dishes ⭐️',
...
const ku: TranslationStrings = {
    ...
    dashboard_daily_revenue_margin: 'داهات و قازانجی مانگانە بۆ ساڵی ئێستا',
    dashboard_wastage_title: 'بەفیڕۆچوو',
    ...
    dashboard_top_selling: 'باشترین خواردنەکان لە فرۆشتندا',
    dashboard_worst_selling: 'خراپترین خواردنەکان لە فرۆشتندا',
    ...
    category_signature_dishes: 'خواردنە نایابەکان ⭐️',
...
const arFusha: TranslationStrings = {
    ...
    dashboard_daily_revenue_margin: 'الإيرادات والهامش الشهري للسنة الحالية',
    dashboard_wastage_title: 'الهدر',
    ...
    dashboard_top_selling: 'أكثر الأصناف مبيعاً',
    dashboard_worst_selling: 'أقل الأصناف مبيعاً',
    ...
    category_signature_dishes: 'أطباق مميزة ⭐️',
