        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-center text-sm text-slate-500">
                Need the staff floor view? <Link href="/waiter/login" className="text-amber-600 hover:underline">Sign in as a waiter</Link>
              </p>
            </form>
          </CardContent>
        </Card>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-950 text-white flex items-center justify-center"><p className="text-white/70">Loading signin form…</p></div>}>
      <LoginPageContent />
    </Suspense>
  )
}
